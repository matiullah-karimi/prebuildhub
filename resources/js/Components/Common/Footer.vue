<template>
    <footer class="p-16 bg-[#EEEEEE] pt-[80px] lg:pt-[120px] pb-30 md:pb-[80px] lg:pb-[110px] font-normal bg-no-repeat bg-center bg-cover" style="background-image: url('/images/footer.png');">
            <div class="container">
                <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
                    <div class="col-span-12 sm:col-span-6 lg:col-span-4 mb-[30px]">
                        ...
                        <p class="text-sm hidden md:block">© <a href="https://themeforest.net/user/codecarnival/portfolio" class="text-secondary">CodeCarnival.</a> All Rights Reserved - Privacy Policy</p>
                    </div>
                    <div class="col-span-12 sm:col-span-6 lg:col-span-3 mb-[30px]">
                        ...
                        <ul class="text-[16px] leading-none mb-[-20px]">
                            ...
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="index.html#">Careers</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="index.html#">Payment</a></li>
                    ...
                    <div class="col-span-12 sm:col-span-6 lg:col-span-3 mb-[30px]">
                        ...
                        <ul class="text-[16px] leading-none mb-[-20px]">
                            ...
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="index.html#">Terms &amp;
                                    Conditions</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="index.html#">Help line</a>
                            </li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="agent.html">Our
                                    Agents</a></li>
                            <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="index.html#">features</a></li>
                        </ul>
                    </div>
                    <div class="col-span-12 sm:col-span-6 lg:col-span-2 mb-[30px]">
                        ...
                        <p class="text-sm md:hidden mb-7 sm:mb-0 mt-[20px]">© <a href="https://themeforest.net/user/codecarnival/portfolio" class="text-secondary">CodeCarnival.</a> All Rights Reserved - Privacy Policy</p>
                    </div>
                </div>
            </div>
        </footer>
